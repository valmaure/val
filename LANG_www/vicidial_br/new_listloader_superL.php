...
echo "<!-- SEED TIME  $secX:   $year-$mon-$mday $hour:$min:$sec  LOCAL DIFERENÇA PARA GMT AGORA: $LOCAL_GMT_OFF  DST: $isdst -->\n";
...
function ShowProgress(good, bad, total, dup, post) {
	...
	parent.lead_count.document.write('<html><body><table border=0 width=200 cellpadding=10 cellspacing=0 align=center valign=top><tr bgcolor="#000000"><th colspan=2><font face="arial, helvetica" size=3 color=white>Status do arquivo atual:</font></th></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Good:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+good+'</B></font></td></tr><tr bgcolor="#990000"><td align=right><font face="arial, helvetica" size=2 color=white><B>Bad:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+bad+'</B></font></td></tr><tr bgcolor="#000099"><td align=right><font face="arial, helvetica" size=2 color=white><B>Total:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+total+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Duplicate:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+dup+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Postal Match:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+post+'</B></font></td></tr></table><body></html>');
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Carregar registros do arquivo:</font></B></td>
	<td align=left width="65%"><input type=file name="leadfile" value="<?php echo $leadfile ?>"> <?php echo "$NWB#vicidial_list_loader$NWE"; ?></td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>ID da Lista Override: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $list_id_override ?>" name='list_id_override' size=10 maxlength=8> (somente números or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Sobrepor Código do Telefone: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $phone_code_override ?>" name='phone_code_override' size=8 maxlength=6> (somente números or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right><B><font face="arial, helvetica" size=2>Layout do arquivo a usar:</font></B></td>
	<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Layout Customizado</td>
  </tr>
    <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Verificação de Duplicidade de Registro:</font></td>
	...
	<option value="DUPLIST">CHECK FOR DUPLICATES BY PHONE IN ID DA LISTA</option>
	<option value="DUPCAMP">VERIFICAR REGISTROS DUPLICADOS EM TODAS AS LISTAS DA CAMPANHA</option>
	<option value="DUPSYS">VERIFICAR REGISTROS DUPLICADOS NO SISTEMA INTEIRO</option>
	<option value="DUPTITLEALTPHONELIST">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN ID DA LISTA</option>
	<option value="DUPTITLEALTPHONESYS">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN ENTIRE SYSTEM</option>
	</select></td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Pesquisa do Fuso Horário do Registro:</font></td>
...
<tr>
	<td align=center colspan=2><input type=submit value="ENVIAR" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick="javascript:document.location='new_listloader_superL.php'" value="REINICIAR" name='reload_page'></td>
  </tr>
  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">VOLTAR PARA ADMIN</a></font></td><td align=right><font size=1>LIST LOADER- &nbsp; &nbsp; VERSÃO: <?php echo $version ?> &nbsp; &nbsp; BUILD: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
<?php } ?>
	...
	if ($OK_to_process) {
		...
		if (!eregi(".csv", $leadfile_name) && !eregi(".xls", $leadfile_name)) {
			...
			if (strlen($list_id_override)>0) 
				{
				print "<BR><BR>ID DA LISTA OVERRIDE FOR THIS FILE: $list_id_override<BR><BR>";
				}

			if (strlen($phone_code_override)>0) 
				{
				print "<BR><BR>SOBREPOR CÓDIGO DO TELEFONE PARA ESTE ARQUIVO: $phone_code_override<BR><BR>";
				}
				...
				print "<center><font face='arial, helvetica' size=3 color='#990000'><B>ERRO: O arquivo não possui a quantidade de campos requerida para continuar.</B></font></center>";
			}
...
if ($leadfile) {
	...
	#	echo "|$WeBServeRRooT/vicidial/listloader.pl --forcelistid=$list_id_override --lead-file=$lead_file|";
		...
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=false; document.forms[0].submit_file.disabled=false; document.forms[0].reload_page.disabled=false;</script>";
			...
			print "    <th align=right><font class='standard' color='white'>VICIDIAL Coluna</font></th>\r\n";
			print "    <th><font class='standard' color='white'>Dados do arquivo</font></th>\r\n";
			print "  </tr>\r\n";
			...
			print "    <th colspan=2><input type=submit name='OK_to_process' value='OK PARA PROCESSAR'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick=\"javascript:document.location='new_listloader_superL.php'\" value=\"REINICIAR\" name='reload_page'></th>\r\n";
			print "  </tr>\r\n";
			print "</table>\r\n";
	# }
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=false; document.forms[0].submit_file.disabled=false; document.forms[0].reload_page.disabled=false;</script>";
...
if ( (!$AC_processed) and ($dst_range == 'SSM-FSN') )
	...
	#**********************************************************************
		...
		if ($dd > 7) {
			...
			} else { # horário local calculations
			if ($ns < 7200) {
				$USACAN_DST=1;   
			} else {
				$USACAN_DST=0;   
