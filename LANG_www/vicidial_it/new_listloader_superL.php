...
<tr>
  ...
  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">TORNA AD AMMINISTRAZIONE</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_third_gen.php">3rd Gen Lead Loader</a> &nbsp; &nbsp; </font></td><td align=right><font size=1>LIST LOADER- &nbsp; &nbsp; VERSIONE: <?php echo $version ?> &nbsp; &nbsp; BUILD: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
<?php } ?>
				...
				while (!feof($file)) {
					...
					if (strlen($buffer)>0) {
						...
						if ($custom_fields_enabled > 0)
							{
							$stmt="MOSTRA TABELLAS LIKE \"custom_$list_id_override\";";
							if ($DB>0) {echo "$stmt\n";}
							$rslt=mysql_query($stmt, $link);
						...
						if ( (strlen($phone_number)>6) and ($dup_lead<1) and ($list_id >= 100 ))
							...
							if ($bad < 1000000)
								...
								if ( $list_id < 100 )
									{
									print "<BR></b><font size=1 color=red>record $total BAD- PHONE: $phone_number ROW: |$row[0]| INVALID ID LISTA</font><b>\n";
									}
								else
									{
