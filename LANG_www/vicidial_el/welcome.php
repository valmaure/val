...
echo "<title>ViciDial Καλωσήρθες</title>\n";
echo "</head>\n";
...
echo "<TD ALIGN=CENTER VALIGN=MIDDLE> Υποδοχή </TD>";
echo "</TR>\n";
...
echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=3><b> <a href=\"../agc/timeclock.php?referrer=welcome\">Ώρα ρολόι</a> </TD></TR>\n";
echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
